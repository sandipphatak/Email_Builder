...
function txtBlock() {
    let newTextAppend = `<tr>
                <td align="center">
                    <span class="topSize" id="head1" style="font-size:36px;color:#000000;font-weight:700;font-family:Poppins,Arial,sans-serif;line-height:54px;text-decoration: none;display: block;padding:0 10px;">Job Opportunity at Hilton</span>
                </td>
            </tr>`
...
function head_txt() {
    ...
    let headTxt = document.getElementById("head1");
    headTxt.innerHTML = headTxtInput.value;
}

// function head_txt_fsize() {
//     let headTxtInput_fsize = document.getElementById("fSize1");
//     let headTxt_fsize = document.getElementById("head1");
